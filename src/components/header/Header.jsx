...
export const Header = ({type}) => {
    ...
    // name = options, operation = increase or decrease
    ...
    <div className="header">
        ...
        <div className="headerSearch">
            ...
            <div className="headerSearchItem">
                ...
                {/* span is inline level -- div is block level */}
                {/* when click date picker open */}
                <span onClick={() => setOpenDate(!openDate)} className="headerSearchText">
                    {/* mm is for minutes format, MM for months format --> so it should be all lowercase but minute has taken it */}
